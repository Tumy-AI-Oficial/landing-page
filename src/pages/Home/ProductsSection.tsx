        ...
        <div className="max-w-7xl mx-auto w-full px-6 md:px-16 lg:px-24 mb-8 md:mb-12 select-none shrink-0">
          ...
          <BlurFade delay={0.2} inView>
            <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight">
              Proyectos <span className="font-light">destacados</span>
            </h2>
          </BlurFade>
        </div>
        ...
        <div className="w-full relative flex items-center">
          ...
          >
            {projects.map((proj, idx) => (
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-xs md:text-sm text-neutral-500 dark:text-neutral-450 leading-relaxed font-normal">
                    {proj.description}
                  </p>

                  <div className="space-y-2 pt-2 border-t border-neutral-200 dark:border-neutral-800">
                    <p className="text-[9px] font-mono uppercase tracking-wider text-neutral-400">Detalles de entrega:</p>
            ...
            <div className="w-[30vw] md:w-[200px] shrink-0 flex flex-col justify-center items-center text-center p-6 select-none">
              ...
              <p className="text-[10px] font-mono uppercase tracking-widest text-neutral-400">Continúa el scroll</p>
            </div>
          </motion.div>
        </div>
      </div>
